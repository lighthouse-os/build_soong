...
func Banner(make_vars map[string]string) string {
	...
	fmt.Fprintln(b, "             *oooo*                ")
	fmt.Fprintln(b, "             *oooo*                ")
	fmt.Fprintln(b, "            *oo**oo*               ")
	fmt.Fprintln(b, "           *oooooooo*              ")
	fmt.Fprintln(b, "          *oooooooooo*             ")
	fmt.Fprintln(b, "         **.oooooooo.**            ")
	fmt.Fprintln(b, "         *.oooo**oooo.*            ")
	fmt.Fprintln(b, "  ....*....*ooooooooo*....*....    ")
	fmt.Fprintln(b, "    ...*ooooooooooooooooo*...       ")
	fmt.Fprintln(b, " .**ooooooooooooooooooooooooo**.   ")
	fmt.Fprintln(b, ".*******************************.  ")
	fmt.Fprintln(b, "")
